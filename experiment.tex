...
\begin{figure*}[!ht]
	...
	\adjustbox{width=.95\linewidth}{
		\begin{tabular}{ccccccc}
			...
			\includegraphics[width=1in]{figs/correct/clock_res.jpg} & \includegraphics[width=1in]{figs/correct/miao_res.jpg} & \includegraphics[width=1in]{figs/correct/sjd_res.jpg}\\
